...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다_실패() throws Exception {
        //given
        String title = "title";
        String content = "content";
        PostsSaveRequestDto requestDto = PostsSaveRequestDto.builder()
    ...
    @Test
    @WithMockUser(roles="GUEST")
    public void Posts_수정된다_실패() throws Exception {
        //given
        ...
        //then
        List<Posts> all = postsRepository.findAll();
        Assertions.assertThat(all.get(0).getTitle()).isNotEqualTo(expectedTitle);
        Assertions.assertThat(all.get(0).getContent()).isNotEqualTo(expectedContent);
    }
